        ...
        container('kaniko') {
          script {
              sh '''
                ...
                /kaniko/executor --cleanup --cache=false --dockerfile=Dockerfile.prod --context=dir://. --destination=924809052459.dkr.ecr.us-east-1.amazonaws.com/user-service:latest
              '''
          }
        }
      }
